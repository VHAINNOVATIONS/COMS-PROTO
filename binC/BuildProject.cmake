...
macro(add_sources)
	...
	file (GLOB_RECURSE java_files C:/projects/Web-Automation-Testing-Framework/src/*.java)
	foreach(java_file ${java_files})
		file(RELATIVE_PATH full_path "C:/projects/Web-Automation-Testing-Framework" ${java_file})
...
macro(add_jars)
	...
	file (GLOB_RECURSE jars C:/projects/Web-Automation-Testing-Framework/lib/*.jar)
	foreach(jar ${jars})
		file(RELATIVE_PATH full_path "C:/projects/Web-Automation-Testing-Framework" ${jar})
...
macro(add_resources)
	...
	file (GLOB_RECURSE resources C:/projects/Web-Automation-Testing-Framework/src/*.properties)
	foreach(resource ${resources})
		file(RELATIVE_PATH full_path "C:/projects/Web-Automation-Testing-Framework" ${resource})
...
function(compile_package _TARGET_NAME)
    ...
    set(CMAKE_JAVA_INCLUDE_PATH
		...
		"C:/projects/Web-Automation-Testing-Framework/lib/*"
    )
	...
	copy_file(C:/projects/Web-Automation-Testing-Framework/lib 
    ...
    if (_JAVA_COMPILE_FILES)
		...
		execute_process(
            ...
            WORKING_DIRECTORY "C:/projects/Web-Automation-Testing-Framework"
...
macro(add_properties java_class_ouput_dir)
	foreach(resource ${RCS})
		...
		copy_file(C:/projects/Web-Automation-Testing-Framework/${resource} 
...
macro(setup_one_jar)
	...
	set(directories
		"C:/projects/Web-Automation-Testing-Framework/binC/${project_name}/main"
		"C:/projects/Web-Automation-Testing-Framework/binC/${project_name}/lib"
	)
	file(MAKE_DIRECTORY ${directories})
	
	#Copy project_jar into main and all libs into new lib folder
	file (GLOB_RECURSE jars C:/projects/Web-Automation-Testing-Framework/binC/${project_name}_DIR/lib/*)
	file (GLOB_RECURSE project_jar C:/projects/Web-Automation-Testing-Framework/binC/${project_name}*.jar)
	copy_file("${jars}"
			"C:/projects/Web-Automation-Testing-Framework/binC/${project_name}/lib")
	file (RENAME ${project_jar} "C:/projects/Web-Automation-Testing-Framework/binC/${project_name}/main/${project_name}.jar")
	
	#Unjar the one-jar-boot-0.97.jar file into the root directory, and delete the "src" tree
	file (GLOB_RECURSE one_jar C:/projects/Web-Automation-Testing-Framework/binC/${project_name}/lib/one-jar*.jar)
	execute_process(
		COMMAND "C:/Program Files/Java/jdk1.7.0_09/bin/jar.exe" xf ${one_jar}
		WORKING_DIRECTORY "C:/projects/Web-Automation-Testing-Framework/binC/${project_name}"
		ERROR_VARIABLE FunctionalError
	)
	if(FunctionalError)
		message(FATAL_ERROR "${FunctionalError}")
	endif()	
	file (REMOVE_RECURSE "C:/projects/Web-Automation-Testing-Framework/binC/${project_name}/src")
	
	#Edit the boot-manifest.mf file and add a new line: One-Jar-Main-Class: your-main-class
	file(APPEND "C:/projects/Web-Automation-Testing-Framework/binC/${project_name}/boot-manifest.mf" "One-Jar-Main-Class: ${CMAKE_JAVA_JAR_ENTRY_POINT}")
	
	#build new jar eg: jar -cvfm ../one-jar.jar boot-manifest.mf .
	execute_process(
		COMMAND "C:/Program Files/Java/jdk1.7.0_09/bin/jar.exe" -cvfm ../${project_name}.jar boot-manifest.mf .
		WORKING_DIRECTORY "C:/projects/Web-Automation-Testing-Framework/binC/${project_name}"
		ERROR_VARIABLE FunctionalError
	)
	if(FunctionalError)
...
file (REMOVE_RECURSE "C:/projects/Web-Automation-Testing-Framework/binC/${project_name}")
file (REMOVE_RECURSE "C:/projects/Web-Automation-Testing-Framework/binC/${project_name}_DIR")
file (REMOVE_RECURSE "C:/projects/Web-Automation-Testing-Framework/binC/${project_name}.jar")

endmacro()

macro(test_build)
	message(STATUS "Running tests... C:/projects/Web-Automation-Testing-Framework/binC/${project_name}.jar")
	execute_process(COMMAND "C:/Program Files/Java/jdk1.7.0_09/bin/java.exe" -jar "C:/projects/Web-Automation-Testing-Framework/binC/${project_name}.jar" ERROR_VARIABLE FunctionalError)
	if(FunctionalError)
		message(FATAL_ERROR "${FunctionalError}")
	endif()
endmacro()                 
