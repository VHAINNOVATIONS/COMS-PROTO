	...
	public $TableInfo = array(
		"Order_Status" => array(
			"Columns" => array(
				...
				"Date_Modified" => "Never used, always NULL",
				"Notes" => "Used but data is meaningless",
				"FluidType" => "Never used, always NULL",
				"FluidVol" => "Never used, always NULL",
				"InfusionTime" => "Never used, always NULL",
				"AdminTime" => "Never used, always NULL",
				"FluidVol" => "Never used, always NULL",
				"FluidVol" => "Never used, always NULL",
				"FluidVol" => "Never used, always NULL",
				"FluidVol" => "Never used, always NULL",
				"Type" => "Never used, always NULL",
				"RegNum" => "Never used, always NULL",
				"RegDose" => "Never used, always NULL",
				"RegDoseUnit" => "Never used, always NULL",
				"RegDosePct" => "Never used, always BLANK",
				"RegReason" => "Never used, always BLANK",
				"PatientDose" => "Never used, always BLANK",
				"PatientDoseUnit" => "Never used, always BLANK",
				"flunit" => "Never used, always BLANK",
				"bsaDose" => "Never used, always BLANK",
				"Reason" => "Never used, always BLANK"
			),
			"Keys" => array(
	...
	function buildTableRow($aColumn, $ColDefault, &$pKeyMap) {
		...
		if ("" !== $pKey) {
			...
			if ("COMS_Track" == $tName && "id" === $cName) {
				...
				$keyType = "Primary Key - Passed as GUID by Calling Function";
			}
				...
				$keyType = "Foreign Key = Master_Template";
			}
			else if ("Order_Status" == $tName && "Drug_ID" === $cName) {
				$keyType = "Foreign Key = Medication_Hydration (as MH_ID)";
			}
 ...
 <table>
   <tr>" .
	...
	function schema($db = null) {
		...
		$styles = "<link rel=\"stylesheet\" id=\"COMS_Theme\" type=\"text/css\" href=\"/libs/ExtJS_4.1.0/resources/css/ext-all.css\">\n" .
		" <link rel=\"stylesheet\" id=\"COMS_Theme1\" type=\"text/css\" href=\"js/COMS.css\">\n" .
		" <style>\n" . 
		"	h1 { \n" .
		"		text-align: center; \n" .
		"		font-size: 200%; \n" .
