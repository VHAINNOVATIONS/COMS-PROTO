...
//echo "<br>";
    ...
    public function Mega($type = null, $value = null)
    {
        ...
        if (null != $type && null != $value) {
            ...
            if (null != $client && !is_array($client)) {
                ...
                } elseif (false === $vitalsJson['success']) {
                    $jsonRecord = $vitalsJson;
                } elseif (false === $LabInfoJson['success']) {
    ...
    public function LabInfoResults($lastFour, $existingClient = null)
    {
        $jsonRecord = array();
    ...
    public function Allergies($lastFour, $existingClient = null)
    {
        $jsonRecord = array();
    ...
    public function AllVitals($lastFour, $existingClient = null)
    {
        $jsonRecord = array();
...
//                $jsonRecord['message'] = count($AllVitals) . ' Vital Records Saved';		// MWB - 5/7/2012 - Added additional information to outgoing message
    ...
    public function MDWSAllVitals($client)
    {
        if (null === $client) {
            return "";
        }
        ...
        if ($count>0) {
            ...
            } elseif (isset($tmpResult->VitalSignSetTO)) {
    ...
    public function MDWSLabInfo($client, $startDate, $endDate)
    {
        if (null === $client) {
            return "";
        }
        ...
        if ($count>0) {
            ...
            } elseif (isset($tmpResult->ChemHemRpt)) {
    ...
    public function MDWSAllergies($client)
    {
        if (null === $client) {
            return "";
        }
        ...
        if ($count>0) {
            ...
            } elseif (isset($tmpResult->AllergyTO)) {
