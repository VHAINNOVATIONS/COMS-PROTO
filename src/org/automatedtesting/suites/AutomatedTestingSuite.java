...
//	}
	...
	public Properties getProperties() {
		...
		InputStream in = AutomatedTestingSuite.class.getResourceAsStream("suite.properties");
		try {
			prop.load(in);
			in.close();
		} catch (IOException e) {
	...
	public static boolean verify(String testName, By actualStatement, String expectedValue){
