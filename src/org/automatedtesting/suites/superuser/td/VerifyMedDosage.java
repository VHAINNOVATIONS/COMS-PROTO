...
public class VerifyMedDosage extends AutomatedTestingSuite {
	
	@Test
	public HashMap RunVerifyMedDosage() {
		
		try{
			strTime = System.currentTimeMillis();
			LogbackFileUtils.start(this.getClass());
			logger.info(":: In Start of VerifyMedDosage() method");
			...
			//Logout
			logger.info("::End of VerifyMedDosage() method ::");
			LoginLogout.logout();		    
