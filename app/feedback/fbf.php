...
<form enctype="multipart/form-data" action="fproc.php" method="post">
  ...
  <tr>
    <td colspan="2"><textarea name="Feedback" cols="65" rows="25"></textarea></td>
  </tr>
  
      <tr><td colspan="2"><div align="left">File Attachment Description (optional):</div></td></tr>
      <tr><td colspan="2"><input type="text" name="file_info" size="40"><input type="hidden" name="MAX_FILE_SIZE" value="10000000"> </td></tr>
    <tr><td colspan="2"><div align="left">File to upload:</div></td></tr>
    <tr><td colspan="2"><input type="file" name="attachment" id="attachment" size="30"></td></tr>
    <tr><td colspan="2">&nbsp;</td></tr>
  <tr>
