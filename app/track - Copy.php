...
function PostTrack($ruser,$AccessCode,$point,$pointno){
	include "dbitcon.php";
		//GetID
		...
		$date2 = date("F j, Y");
		//Insert into SQL
		$tsql1 = "INSERT INTO COMS_Track (id,ip,compname,ref,username,winauth,point,pointno,time,date2) VALUES ($newid,'$ip_vistor','$compname','$url','$AccessCode','$ruser','$point','$pointno','$time','$date2')";
