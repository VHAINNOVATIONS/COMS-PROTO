...
VALUES ($newid,'$Module','$Feedback','$userid','$filename','$file_info','$compname','$ip_vistor','$Severity','$Probability','$Priority','$Title','Open','$TrackNumber','$RepeatSteps','$Solution','$FilesChanged','$Comments','Comment')";
