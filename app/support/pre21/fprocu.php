...
$tsql = "INSERT INTO COMS_UAT (id,module,feedback,userid,attachment,file_info,compname,ip_vistor,Severity,Probability,Priority,Title,Status,TrackNumber) 
VALUES ($newid,'$Module','$Feedback','$userid','$filename','$file_info','$compname','$ip_vistor','$Severity','$Probability','$Priority','$Title','Comment','$TrackNumber')";
...
//$To = 'dbitpro@gmail.com,sean.cassidy@dbitpro.com'; 
