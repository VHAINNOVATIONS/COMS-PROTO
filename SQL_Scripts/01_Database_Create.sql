...
/****** Object:  Database [COMS_TEST_3]    Script Date: 04/24/2014 11:21:41 *****/
/* Note: Set the filepath for your SQL Directory*/
CREATE DATABASE [COMS_TEST_3] ON  PRIMARY 
( NAME = N'COMS_TEST_3_Data', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10.DBIT\MSSQL\DATA\COMS_TEST_3_Data.mdf' , SIZE = 16512KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'COMS_TEST_3_Log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10.DBIT\MSSQL\DATA\COMS_TEST_3_Log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 1024KB )
GO
